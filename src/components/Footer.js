...
const Footer = () => {
  return (
    ...
    <div className='w-full border-t-2 border-red-500 flex flex-col items-center text-[11px] mx-auto'>
        ...
        <div className='flex justify-around bg-red-500 w-full h-[7vh] p-3 mt-3'>
